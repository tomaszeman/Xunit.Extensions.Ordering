...
**Version 2.+** provides simplification of usage and more consitant extensibility with Xunit.

Migration from v1:
- All orderers are default so no need to define at assembly level explicitely
- new TestClassOrderer
...
## Test cases ordering
### Setup ordering  
Change TestFramework by adding `AssemblyInfo.cs` file with only following lines of code
```csharp
using Xunit;
